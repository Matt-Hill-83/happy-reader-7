      ...
      frames: [
        {
          frameConfig: {
            items: [],
            faces: [
              { face: "liz-8.5a65d801.png", character: "liz2" },
        ...
        },
        {
          frameConfig: {
            items: [],
            faces: [
              { face: "liz-22.c5ad2fd2.png", character: "liz2" },
      ...
      frames: [
        {
          frameConfig: {
            items: [],
            faces: [
              { face: "liz-15.a0aad93e.png", character: "liz2" },
        ...
        },
        {
          frameConfig: {
            items: [],
            faces: [
              { face: "liz-12.d70620b2.png", character: "liz2" },
      ...
      frames: [
        {
          frameConfig: {
            items: [],
            faces: [
              { face: "liz-7.7d66b803.png", character: "liz2" },
              { face: "kat-unsure.35db04b3.png", character: "kat" },
            ],
            creatures: ["kat", "liz2"],
          },
        ...
        },
        {
          frameConfig: {
            items: [],
            faces: [
              { character: "liz2", face: "liz-15.a0aad93e.png" },
      ...
      frames: [
        {
          frameConfig: {
            ...
            faces: [
              { face: "liz-7.7d66b803.png", character: "liz2" },
              { character: "kat", face: "kat-optimistic.ded8aa68.png" },
            ],
            creatures: ["kat", "liz2"],
          },
          dialogs: [
      ...
      frames: [
        ...
        },
        {
          frameConfig: {
            items: [],
            faces: [
              { character: "liz2", face: "liz-7.7d66b803.png" },
              { face: "kat-hurt.b1c80ebb.png", character: "kat" },
            ],
            creatures: ["kat", "liz2"],
          },
          dialogs: [
      ...
      frames: [
        {
          frameConfig: {
            items: [],
            faces: [
              { face: "liz-18.817bd03d.png", character: "liz2" },
        ...
        },
        {
          frameConfig: {
            items: [],
            faces: [
              { face: "liz-4.481f07e2.png", character: "liz2" },
              { face: "kat-smiling.49647334.png", character: "kat" },
            ],
            creatures: ["kat", "liz2"],
          },
