      ...
      frames: [
        ...
        },
        {
          ...
          dialogs: [
            ...
            '{"kat" : "Katie!!!!"}',
            '{"kat" : "Stoooooop Talking!"}',
            '{"kat" : "Listen to the words coming out of my mouth. There is no rap."}',
          ],
        },
        {
          frameConfig: { items: [], faces: [] },
      ...
      frames: [
        ...
        },
        {
          ...
          dialogs: [
            ...
            '{"kat" : "Then there was this..."}',
            '{"kat" : "...dog stuck in a bog wearing clogs!"}',
      ...
      frames: [
        {
          frameConfig: { items: [], faces: [] },
          dialogs: [
            '{"kat" : "I make my parent groan a lot."}',
            '{"kat" : "But that rumble? That\'s my tummy from the soda pop."}',
            '{"kat" : "Call the doc!"}',
