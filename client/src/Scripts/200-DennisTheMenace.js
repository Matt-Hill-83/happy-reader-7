      ...
      frames: [
        {
          ...
          dialogs: [
            '{"kat" : "Hi Dennis!"}',
            '{"liz2" : "Dennis: Oh hi Kat! What are you up to?"}',
            '{"liz2" : "Just some trouble."}',
            '{"liz2" : "Dennis: Count me in. But keep an eye out for Mr. Wilson. He\'s not going to be too happy when he finds out what happened to his new shoes!"}',
          ],
        },
        {
          frameConfig: {
          ...
          dialogs: [
            ...
            '{"liz2" : "You don\'t even want to know. Where\'s the fun at?"}',
            '{"liz2" : "Well, there\'s this new girl named Rori. She needs a place to hide her dragon."}',
            '{"liz2" : "Dennis: Well now you are talking my language. Have I ever told you about Mr. Wilson\'s shed?"}',
          ],
        },
        {
          frameConfig: {
          ...
          dialogs: [
            '{"kat" : "Keep talking..."}',
            '{"liz2" : "It\'s dustier than a book of manners in a schoolyard, but it might to the trick."}',
            '{"liz2" : "We will pass that along to Rori."}',
        ...
        },
        {
          ...
          dialogs: [
            '{"kat" : "I have a ball of lint and this thumb tack, but I\'m saving it to make a surprise for Mr. Wilson."}',
            '{"liz2" : "Lucky him!"}',
            '{"liz2" : "Dennis: Yeah, he must have been born under a 4 leaf clover."}',
