...
import css from "./StoryPickerPage.module.scss"
...
const youNameDefault = "Test"

class StoryPickerPage extends React.Component {
  state = {
...
export default observer(StoryPickerPage)
